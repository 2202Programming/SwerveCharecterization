...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    CANSparkMax leftFollowerID22 = setupCANSparkMax(22, Sides.FOLLOWER, false);
    leftFollowerID22.follow(leftMotor, false);
        
    

    CANSparkMax rightMotor = setupCANSparkMax(24, Sides.RIGHT, true);
    CANSparkMax rightFollowerID26 = setupCANSparkMax(26, Sides.FOLLOWER, true);
    rightFollowerID26.follow(rightMotor, true);
